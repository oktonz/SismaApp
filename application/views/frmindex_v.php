...
<head>
    ...
    -->
    <meta charset="utf-8">
    <title>Input Index - Sistem Manajemen Arsip</title>
                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            <h2><i class="glyphicon glyphicon-star-empty"></i> Form Input Index Dokumen</h2>
                        ...
                        <div class="box-content">
                            <form class="form-horizontal" role="form" method="post" action="<?php echo base_url().'input/do_input_index';?>">
