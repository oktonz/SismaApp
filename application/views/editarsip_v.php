                            ...
                            <form class="form-horizontal" role="form" method="post" action="<?php echo base_url().'arsip/do_edit_arsip';?>">
                              <?php foreach ($arsip as $ars) {?>
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-3">
                                    <?php
                                        $select = $ars['index_arsip'];                                                                              
                                        $items = array();
                                        foreach ($idx as $inx) {
                                          $items[$inx['index_arsip']] = $inx['index_arsip'];
                                        }                                                                                                                  
                                      echo form_dropdown('cboidx', $items, $select, 'class="form-control"');
                                    ?>                                   
                                  </div>
                                </div>
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-4">          
                                    <input type="text" class="form-control" name="txtkode" value="<?php echo $ars['kd_pekerjaan'];?>" readonly>
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label class="control-label col-sm-2" for="namapkrj">Nama Pekerjaan:</label>
                                  <div class="col-sm-8">          
                                    <input type="text" class="form-control" name="txtnamapkrj" value="<?php echo $ars['nm_pekerjaan'];?>">
                                  </div>
                                </div>
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-2">
                                    <?php
                                      ...
                                      echo form_dropdown('cbounit', $items, $select, 'class="form-control"');
                                    ?>   
                                  </div>
                                </div>
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-2">          
                                    <input type="text" class="form-control" name="txttahun" value="<?php echo $ars['tahun'];?>">
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label class="control-label col-sm-2" for="provinsi">Provinsi:</label>
                                  <div class="col-sm-4">          
                                    <input type="text" class="form-control" name="txtprovinsi" value="<?php echo $ars['provinsi'];?>">
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label class="control-label col-sm-2" for="kabupaten">Kabupaten:</label>
                                  <div class="col-sm-4">          
                                    <input type="text" class="form-control" name="txtkabupaten" value="<?php echo $ars['kabupaten'];?>">
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label class="control-label col-sm-2" for="kecamatan">Kecamatan:</label>
                                  <div class="col-sm-4">          
                                    <input type="text" class="form-control" name="txtkecamatan" value="<?php echo $ars['kecamatan'];?>">
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label class="control-label col-sm-2" for="desa">Desa:</label>
                                  <div class="col-sm-4">          
                                    <input type="text" class="form-control" name="txtdesa" value="<?php echo $ars['desa'];?>">
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label class="control-label col-sm-2" for="status">Status:</label>
                                  <div class="col-sm-2">          
                                    <input type="text" class="form-control" name="txtstatus" value="<?php echo $ars['status'];?>">
                                  </div>
                                </div>
                                <div class="form-group">
