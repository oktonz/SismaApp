...
<head>
    ...
    -->
    <meta charset="utf-8">
    <title>Profil - Sistem Manajemen Arsip</title>
                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            <h2><i class="glyphicon glyphicon-star-empty"></i> Profil User</h2>
                        ...
                        <div class="box-content">
                            <form class="form-horizontal" role="form">
                                <?php foreach ($usernow as $unow) { ?>
                                <div class="form-group">
                                  <label class="control-label col-sm-2" for="Nama">Nama Lengkap : </label>
                                  <div class="col-sm-8">
                                    <label class="control-label" for="datanama"><?php echo $unow['nama'];?></label>
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label class="control-label col-sm-2" for="alamat">Alamat : </label>
                                  <div class="col-sm-8">          
                                    <label class="control-label" for="dataalamat"><?php echo $unow['alamat'];?></label>
                                  </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-8">          
                                    <label class="control-label" for="datatpt"><?php echo $unow['tpt_lahir'];?></label>
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label class="control-label col-sm-2" for="tanggal">Tanggal Lahir : </label>
                                  <div class="col-sm-8">          
                                    <label class="control-label" for="datatgl"><?php echo $unow['tgl_lahir'];?></label>
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label class="control-label col-sm-2" for="username">Username : </label>
                                  <div class="col-sm-8">          
                                    <label class="control-label" for="datausername"><?php echo $unow['username'];?></label>
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label class="control-label col-sm-2" for="role">Role : </label>
                                  <div class="col-sm-8">          
                                    <label class="control-label" for="datarole"><?php echo $unow['role'];?></label>
                                  </div>
                                </div>
                                <div class="form-group">        
